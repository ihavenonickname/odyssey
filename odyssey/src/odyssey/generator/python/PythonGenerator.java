...
public class PythonGenerator implements Generator {
	...
	static {
		...
		binaryOperators.put(Token.PLUS_KEYWORD, " + ");
		binaryOperators.put(Token.MINUS_KEYWORD, " - ");
		binaryOperators.put(Token.TIMES_KEYWORD, " * ");
		binaryOperators.put(Token.DIVIDED_KEYWORD, " / ");
		binaryOperators.put(Token.MODULUS_KEYWORD, " % ");
		binaryOperators.put(Token.AND_KEYWORD, " and ");
